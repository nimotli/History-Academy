        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 my-4 p-3">
                    ...
                    <div class="radio">
                    <label><input type="radio" name="paymentAnalysis" value="manual" checked> التحويل</label>
                    </div>
                    </form>
                </div>
                <div class="col-md-6 my-4 border p-3">
                    <div id="manual" >
                        <h3>المرجو ارسال {{analysis.price}} $ باستخدام المعلومات أسفله </h3>
                    ...
                    <div id="automated" style="display:none;">
                        <h3>الثمن : {{analysis.price}} $</h3>
                        <a href="mvc/controllers/payementController.php?action=pay&type=analysis&id={{analysis.id}}"class="btn btn-warning"> ادفع الان</a>
                    </div>
                </div>
            </div>

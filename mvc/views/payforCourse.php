        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-6 my-4 border p-3">
                    <div id="manual" >
                        <h3>المرجو ارسال {{course.price}} $ باستخدام المعلومات أسفله </h3>
                    ...
                    <div id="automated" style="display:none;">
                        <h3>الثمن : {{course.price}} $</h3>
                        <a href="mvc/controllers/payementController.php?action=pay&type=course&id={{course.id}}"class="btn btn-warning"> ادفع الان</a>
                    </div>
                </div>
            </div>
